...
const Navbar = () => {
  ...
  return (
    <div className={`fixed w-full z-50 top-0 left-0 transition-all duration-500 ${scrolled ? 'pt-2 px-4' : 'pt-4 px-4 sm:px-6 lg:px-8'}`}>
      <nav className={`mx-auto max-w-7xl rounded-full transition-all duration-500 ${
        scrolled 
        ...
        <div className="flex justify-between items-center h-12 md:h-14">
          ...
          <Link href="/" className="flex items-center gap-2 cursor-pointer group z-50">
            ...
            <div className="flex items-baseline">
              <span className="text-white text-xl sm:text-2xl font-black tracking-tight uppercase">Build</span>
      ...
      <div 
        className={`absolute top-20 left-4 right-4 md:hidden overflow-hidden transition-all duration-500 origin-top ${
